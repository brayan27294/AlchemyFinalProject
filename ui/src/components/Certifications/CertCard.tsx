        ...
        <CardHeader
          ...
          <CardContent>
            <Typography variant='body2' color='text.secondary'>
              ...
              if you like.{certification.description}
            </Typography>
          </CardContent>
          <CardActions disableSpacing>
            ...
            {role === 'certifier' &&
            <IconButton aria-label='Edit' onClick={() => editHandler?editHandler(true):null}>
              <EditIcon />
            </IconButton>
            }
            <ExpandMore
          ...
          <Collapse in={expanded} timeout='auto' unmountOnExit>
            <CardContent>
              ...
              <FormGroup>
                {certification.requirements.map((item, index) => <FormControlLabel key={`rerquirement_${certification.name}_${index}`} control={<Checkbox />} label={item} />)}
              </FormGroup>
            </CardContent>
          </Collapse>
        </Card>
